        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h3 className="text-lg font-display font-bold italic">{empresa.nome || 'M.E burgue'}</h3>
                <p className="text-[10px] text-[#FF4D00] font-black uppercase tracking-[0.2em] -mt-1">O Sabor do Hambúrguer</p>
              </div>
            </div>
      ...
      <div className="border-t border-white/5 py-6 pb-28 md:pb-6">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs">
            © {new Date().getFullYear()} {empresa.nome || 'M.E burgue'}. Todos os direitos reservados.
          </p>
          <a 
